...
// an image barrier rather than a render pass because each render pass does not whether or not it
// is the last pass in the frame. (This seems to be an atypical of way of achieving the transition,
